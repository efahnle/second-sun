...
from light_to_use import light_progress_for_the_day, absolute_light_for_day_in_year, days_since_summer_solstice
...
light_is_on = Gauge('second_sun_light_is_on', 'Whether the light is currently on (1) or off (0)')
light_brightness = Gauge('second_sun_light_brightness', 'Current brightness percentage of the light')
light_progress_day = Gauge('second_sun_light_progress_day', 'Light progress for the current day (0-1)')
absolute_light_year = Gauge('second_sun_absolute_light_year', 'Absolute light value for the current day of year (0.7-1.0)')
